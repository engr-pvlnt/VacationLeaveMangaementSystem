...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_stmt = $conn->prepare("UPDATE leave_requests SET 
                                   ...
                                   approval_notes = ? 
                                   WHERE id = ?");
    $update_stmt->bind_param("isi", $user_id, $approval_notes, $request_id);
    ...
    if ($update_stmt->execute()) {
        ...
        $error = "Error approving request. Please try again.";
    }
}
?>
...
<head>
    ...
    <title>VLMS - Approve Leave Request</title>
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div>
                    <h1 class="card-title">Approve Leave Request</h1>
                    <p style="color: #666; margin-top: 5px;">Review and approve this leave request</p>
                </div>
            </div>
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <textarea name="approval_notes" id="approval_notes" placeholder="Add any notes or comments regarding this approval..."></textarea>
                </div>
