...
$pending_requests_query = "SELECT lr.*, lt.name as leave_type_name, lt.color as leave_type_color
...
if ($pending_requests_result->num_rows == 0) {
  $simple_query = "SELECT * FROM leave_requests WHERE user_id = ? AND status = 'pending' ORDER BY created_at DESC";
  $simple_stmt = $conn->prepare($simple_query);
  $simple_stmt->bind_param("i", $user_id);
  $simple_stmt->execute();
  $pending_requests_result = $simple_stmt->get_result();
}
...
<head>
  ...
  <title>VLMS - Pending Requests</title>
  ...
  <div class="container">
    ...
    <div class="page-header">
      <div class="page-title">
        ...
        <div class="title-text">
          ...
          <p class="header-description">View and manage your pending leave requests</p>
        </div>
      </div>
    ...
    <div class="requests-section">
      <h2 class="section-title">
        ...
        Pending Requests (<?php echo $stats['pending'] ?? 0; ?>)
      </h2>
              ...
              <tr>
                ...
                <td>
                  <div class="actions-cell">
                    <a href="edit_request?id=<?php echo $request['id']; ?>" class="btn-sm btn-edit">
                      <i class="fas fa-edit"></i>
                      Edit
                    </a>
                    <a href="cancel_request?id=<?php echo $request['id']; ?>" class="btn-sm btn-cancel">
